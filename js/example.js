...
app.post("/", function(req, res){
    sql.connect(config, function(err){
        if(err)console.log(err);
        let request = new sql.Request();
        request.query("INSERT INTO CovidStatic VALUES ('" + req.body.covidID +"','"+ req.body.covidDate + "','"
        + req.body.confirmedCases+"','" + req.body.dailyDeaths+"' '" +req.body.country+"', '" + req.body.totalLoss + "')", 
